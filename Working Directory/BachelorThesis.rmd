...
```{r}
pacman::p_load(pacman, tidyverse, GADMTools, cowplot, car)
```
...
# On the distribution of elevation levels within the data 
...
PlotAsBarsFrequencyOfElevationLevels
...
# Linear Regression for the purpose of evaluating the residuals 
...
PlotAsBarsFrequencyOfStandardizedResidualsLinearRegression

```

## Evaluating the assumption of gaussian-distributed random errorterms

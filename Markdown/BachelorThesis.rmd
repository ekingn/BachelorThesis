...
```{r Enable relative path and project package library}
library(here)
```
...
source(here("Scripts","Functions","Changing-Decimal-Seperator-To-Comma.R"))
```
...
# Various manipulations of the orginal precipitation data of daily resolution 

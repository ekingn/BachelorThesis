...
## Spatial Semivariogram Equation

$$
\gamma(d_{spatial},jul_a) = \frac{1}{2|N(d_{spatial})|}\times\sum_{(lon_r,lat_i),(lon_s,lat_k)\epsilon\:N(d_{spatial})}(rain_{lon_r,lat_i,jul_a}, - rain_{lon_s,lat_k,jul_a})^2
$$

## Temporal Semivariogram

$$
\gamma(d_{julian},(lon_r,lat_i)) = \frac{1}{2|N(d_{julian})|}\times\sum_{jul_a,jul_b\:\epsilon\:N(d_{julian})}(rain_{lon_r,lat_i,jul_a}, - rain_{lon_r,lat_i,jul_b})^2
$$

## Spatial Covariance Equation 

## Spatio-Temporal Covariance Equation

$$
\gamma(d_{spatial},jul_a) = \frac{1}{2|N(d_{spatial})|}\frac{1}{2|N(d_{julian})|}\times\sum_{(lon_r,lat_i),(lon_s,lat_k)\epsilon\:N(d_{spatial})}\:\sum_{jul_a,jul_b\:\epsilon\:N(d_{julian})}(rain_{lon_r,lat_i,jul_a} - \hat{\mu}_{jul_a})(rain_{lon_s,lat_k,jul_a} - \hat{\mu}_{jul_b})
$$

...
\newline Classical Linear Regression Model\newline
\textbf{Equation}: 
$$\textbf{Precipitation Height} = ß_0 + ß_1*\textbf{Mean Temperature} + ß_2*Altitude + ß_3*(Longitutde,Latitude)+ß_4*Jualian\:Date\:+e$$

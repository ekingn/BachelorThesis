...
\makeatother
\usepackage{xcolor}
\usepackage[left = 2cm, right = 2cm, top = 2.5cm, bottom =
2.5cm]{geometry}
\usepackage{graphicx}
\makeatletter
...
\begin{floatingfigure}[r]{7cm}
  \includegraphics[width=7cm]{C:/Users/User/Desktop/BachelorThesis/Output/JPGs/Maps/Germany.jpg}
...
\begin{tabular}[t]{l|r|r|r|r|r|r|l|r|r|r|r|r|r}
\hline
name & index & lon & lat & year & month & day & season & days\_since\_earliest\_observation & rain & alt & mean\_temperature & monthly\_mean\_precipitation & EPE\\
\hline
Aachen-Orsbach & 1 & 6.0244 & 50.7983 & 2011 & 4 & 1 & Spring & 5569 & 0.0 & 230.99 & 13.3 & 41.15 & 0\\
\hline
Aachen-Orsbach & 1 & 6.0244 & 50.7983 & 2011 & 4 & 2 & Spring & 5570 & 0.0 & 230.99 & 16.8 & 41.15 & 0\\
\hline
Aachen-Orsbach & 1 & 6.0244 & 50.7983 & 2011 & 4 & 3 & Spring & 5571 & 9.9 & 230.99 & 10.8 & 41.15 & 0\\
\hline
Aachen-Orsbach & 1 & 6.0244 & 50.7983 & 2011 & 4 & 4 & Spring & 5572 & 0.0 & 230.99 & 9.2 & 41.15 & 0\\
\hline
Aachen-Orsbach & 1 & 6.0244 & 50.7983 & 2011 & 4 & 5 & Spring & 5573 & 0.9 & 230.99 & 8.8 & 41.15 & 0\\
\hline
\end{tabular}
\begin{tablenotes}
\item[1] 'index' (=def.) indexnumber of the weather station
\item[2] 'mean\_temperature' (=def.) daily mean temperature
\item[3] 'rain' (=def.) observed precipiation height in millimetre (mm)
\item[4] 'year','month' and 'day' (=def.) the year, month and day of an observation
\item[5] 'season' (=def.) the corresponding one among the annual seasons
\item[6] 'days\_since\_earliest\_observation' (=def.) a type of julian date. The number of days, that have passed since the earliest observation in the whole training data.
\item[7] 'alt' (=def.) altitude level of weather station
\item[8] 'lon' and 'lat' (=def.) longitudinal and latitudinal degree of weather station
\item[9] 'name' (=def.) the city associated with the weather station
\item[10] 'EPE' (=def.) binary variable that indicates the true classification of the respective precipitation event. 1 := Extreme Precipitation Event. 0 := Non-Extreme Precipitation Event
\item[11] monthly\_mean\_precipitation (=def.) typical total precipitation of the respective month for the respective weather station
\end{tablenotes}
\end{threeparttable}}
\end{table}
...
\begin{figure}[htbp]
  \begingroup
  \centering
  \includegraphics[width=1\textwidth]{C:/Users/User/Desktop/BachelorThesis/Output/JPGs/Heatmaps/Heatmap-Spatio-Temporal-Covariance.jpg}
...
\begin{figure}[H]
  \begingroup
  \centering
  \includegraphics[width=1\textwidth]{C:/Users/User/Desktop/BachelorThesis/Output/JPGs/Precipitation-Means/Seasonal-Mean-Precipitation.jpg}
...
\begin{figure}[H]
  \begingroup
  \centering
  \includegraphics[width=1\textwidth]{C:/Users/User/Desktop/BachelorThesis/Output/JPGs/Smooth-Terms/Smooth-Term-Effects.jpg}
...
logic, presents
itself\footnote{The R script for the calculation of the confusion matrix and the associated performance indicators is named \texttt{Inverse-Distance-Weighting-Calculation} and can be found at \text{.\textbackslash BachelorThesis\textbackslash Scripts\textbackslash Data-Manipulation\textbackslash Training-Data\textbackslash Inverse-Distance-Weighting-Calculation.R"}}\}
as
...
\begin{figure}[h]
\includegraphics[width=1\textwidth]{C:/Users/User/Desktop/BachelorThesis/Output/JPGs/Altitude/Distribution-of-Altitude-Levels.jpg}
...
\begin{figure}[h]
\includegraphics[width=1\textwidth]{C:/Users/User/Desktop/BachelorThesis/Output/JPGs/Hovmoellerplots/Latitudinal-Hovmoellerplot-High-Res.jpg}
